...
class DawnEngine {
  ...
  protected:
    ...
    void addGameObject(std::shared_ptr<GameObject> gObjPtr);
    std::shared_ptr<GameObject> createGameObject();
    std::shared_ptr<GameObject> createGameObject(bool isEntity);
    std::shared_ptr<GameObject> createGameObject(bool isEntity, glm::vec3 position);
    std::shared_ptr<GameObject> setupLights();

  public:
    std::vector<std::shared_ptr<GameObject>> gameObjectPtrs;
