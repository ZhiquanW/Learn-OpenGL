...
void testCodes() {
    ...
    // std::cout << glm::to_string(tmpObject.GetModule<dawn_engine::TransformModule>().GetRotationMat());
    std::cout << glm::to_string(
            cubeObject.GetModule<dawn_engine::TransformModule>()->GetScaleMat()) << std::endl;
